...
class TodoistStatsRepository(private val dao: TodoistDao) {
    ...
    /** Returns 7 pairs of (dayLabel, completionCount) for the last 7 days. */
    ...
    suspend fun saveCompletion(taskId: String, taskContent: String) = withContext(Dispatchers.IO) {
    ...
    suspend fun getWeeklyCount(): Int = withContext(Dispatchers.IO) {
