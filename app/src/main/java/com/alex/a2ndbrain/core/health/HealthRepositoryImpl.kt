...
class HealthRepositoryImpl(
    ...
    override fun setCloudSync(sync: CloudHealthSyncManager) {
        cloudSync = sync
    }
     ...
     */
    override suspend fun getHCMetricsIfWearable(): HealthMetrics? = withContext(Dispatchers.IO) {
     ...
     */
    override suspend fun getTodayMetrics(): HealthMetrics = withContext(Dispatchers.IO) {
        try {
     ...
     */
    override suspend fun getPeriodMetrics(days: Int): Pair<List<DailyHealthMetrics>, Boolean> =
     ...
     */
    override suspend fun getWeeklyTrends(): List<Pair<String, HealthMetrics>> = withContext(Dispatchers.IO) {
        try {
     ...
     */
    override suspend fun getSnapshotsForSync(days: Int): List<HealthSnapshotEntity> =
        withContext(Dispatchers.IO) {
            try {
